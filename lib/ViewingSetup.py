...
class ViewingSetup:
    ...
    def __init__(self,
        ...
        NAVIGATION_MATRIX = avango.gua.make_identity_mat(),
        STEREO_MODE = "mono",
        ...
        # self.resolve_pass.BackgroundTexture.value = "data/textures/ocean_evening.png"
        ...
        self.navigation_node = avango.gua.nodes.TransformNode(Name = "navigation_node_athena")
        self.navigation_node.Transform.value = NAVIGATION_MATRIX
